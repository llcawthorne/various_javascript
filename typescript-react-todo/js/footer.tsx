...
// The footer component allows users to filter the lists of tasks by their
// status and displays the count of tasks. This component has no state
// (Note how {} is passed to React.Component as the interface of its state)
// but it has some properties (ITodoFooterProps) that are set by its parent
// component (the TodoApp component).
